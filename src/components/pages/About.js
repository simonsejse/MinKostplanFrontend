  ...
  return (
    <div className='flex-1 bg-primary'>
      <div className='md:mx-auto h-full w-full md:w-[600px] lg:w-[800px] xl:w-[1000px] flex flex-col justify-center divide-y-8 divide-double divide-indigo-500'>
        <div className='w-full flex flex-col lg:flex-row md:space-x-12 mb-8'>
          <img
          ...
          <div className='flex flex-col justify-center space-y-4'>
            ...
            <h3 className='m-5 lg:m-0 text-white leading-5 font-sans text-lg '>
              Hej!
              <br />
            ...
            <div className='m-5 lg:m-0 flex flex-col lg:flex-row lg:space-x-4'>
              <div className='pt-8 w-full lg:w-[130px]'>
                <button class='transition ease-out delay-100 transition-duration-300 hover:-translate-y-2 w-full lg:w-[130px] relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-red-200 via-red-300 to-yellow-200 group-hover:from-red-200 group-hover:via-red-300 group-hover:to-yellow-200 dark:text-white dark:hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400'>
                  <span class='w-full lg:w-[130px] relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0'>
                    Kontakt Mig
                  </span>
                </button>
              </div>
        ...
        <div className='pt-8 p-5 md:p-0 md:pt-8'>
          ...
          <h3 className='text-white leading-5 font-sans text-lg'>
