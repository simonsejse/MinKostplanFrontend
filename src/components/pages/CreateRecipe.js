  ...
  return (
    <div className='flex-1 bg-primary'>
      <div className='h-full flex items-center'>
        <div className='bg-secondary rounded-md min-h-[90%] flex flex-col items-center ml-5 mr-5 flex-1 shadow-form'>
          ...
          <button className='place-items-end h-full bg-accent text-sm font-title uppercase text-white p-2 rounded w-1/2'>
            Upload opskrift
          </button>
        </div>
        <div className='min-h-[90%] mr-4 w-1/5'>
          ...
          <p className='text-xs font-text text-gray-500 text-justify'>
            ...
            kræver også en indsats fra vores brugere, og derfor har vi valgt, at
            for hver opskrift der uploades optjenes der 5 point, hvor at man til
            sidst efter 50 optjente point, kan få gratis medlemsskab. Som tak
            for ens bidrag.
          </p>
        </div>
      </div>
