    ...
    <div className='flex-1 bg-primary'>
      <div className='h-full flex flex-col'>
        <RecipeModal ref={modalRef}>
          ...
          <main className='h mt-10'>
            <div
              id='ingredient-instruction-wrapper'
              className='flex flex-col lg:flex-row'
            >
              <div id='ingredient-wrapper' className='w-full'>
                <h2 className='uppercase text-xl lg:text-2xl font-title2 text-gray-700'>
                  Ingredienser
                </h2>
                <ul className='list-disc list-inside text-gray-500 font-extrabold font-title text-sm lg:text-md ingredient-list'>
              ...
              <div id='instruction-wrapper' className='w-full mt-5 lg:mt-0'>
                ...
                <ul className='list-decimal list-inside text-gray-500 font-extrabold font-title text-sm lg:text-md instruction-list'>
            ...
            <div id='desc-wrapper' className='mt-5'>
              ...
              <p className='text-gray-500 font-extrabold font-title text-sm lg:text-md'>
                {recipe?.description}
              </p>
            </div>
            ...
            <div id='boolean-value-wrapper' className='mt-5'>
              ...
              <div
                ...
                className='grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-8'
              >
                <div
